...
mixin _$ActionItem {
 ...
 String get id; String get agentId; String get type; String get title; Map<String, dynamic> get payload; ActionStatus get status; DateTime get createdAt; String? get agentName; AgentPlatform? get agentPlatform; String? get summary; List<String> get editableFields; DecisionType? get decision; DateTime? get decidedAt; DateTime? get expiresAt;
...
@override
String toString() {
  return 'ActionItem(id: $id, agentId: $agentId, type: $type, title: $title, payload: $payload, status: $status, createdAt: $createdAt, agentName: $agentName, agentPlatform: $agentPlatform, summary: $summary, editableFields: $editableFields, decision: $decision, decidedAt: $decidedAt, expiresAt: $expiresAt)';
}
...
@useResult
$Res call({
 String id, String agentId, String type, String title, Map<String, dynamic> payload, ActionStatus status, DateTime createdAt, String? agentName, AgentPlatform? agentPlatform, String? summary, List<String> editableFields, DecisionType? decision, DateTime? decidedAt, DateTime? expiresAt
});
...
as ActionStatus,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
...
as AgentPlatform?,summary: freezed == summary ? _self.summary : summary // ignore: cast_nullable_to_non_nullable
...
as DecisionType?,decidedAt: freezed == decidedAt ? _self.decidedAt : decidedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String agentId,  String type,  String title,  Map<String, dynamic> payload,  ActionStatus status,  DateTime createdAt,  String? agentName,  AgentPlatform? agentPlatform,  String? summary,  List<String> editableFields,  DecisionType? decision,  DateTime? decidedAt,  DateTime? expiresAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActionItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String agentId,  String type,  String title,  Map<String, dynamic> payload,  ActionStatus status,  DateTime createdAt,  String? agentName,  AgentPlatform? agentPlatform,  String? summary,  List<String> editableFields,  DecisionType? decision,  DateTime? decidedAt,  DateTime? expiresAt)  $default,) {final _that = this;
switch (_that) {
case _ActionItem():
return $default(_that.id,_that.agentId,_that.type,_that.title,_that.payload,_that.status,_that.createdAt,_that.agentName,_that.agentPlatform,_that.summary,_that.editableFields,_that.decision,_that.decidedAt,_that.expiresAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String agentId,  String type,  String title,  Map<String, dynamic> payload,  ActionStatus status,  DateTime createdAt,  String? agentName,  AgentPlatform? agentPlatform,  String? summary,  List<String> editableFields,  DecisionType? decision,  DateTime? decidedAt,  DateTime? expiresAt)?  $default,) {final _that = this;
switch (_that) {
case _ActionItem() when $default != null:
return $default(_that.id,_that.agentId,_that.type,_that.title,_that.payload,_that.status,_that.createdAt,_that.agentName,_that.agentPlatform,_that.summary,_that.editableFields,_that.decision,_that.decidedAt,_that.expiresAt);case _:
  return null;
...
class _ActionItem extends ActionItem {
  const _ActionItem({required this.id, required this.agentId, required this.type, required this.title, required final  Map<String, dynamic> payload, required this.status, required this.createdAt, this.agentName, this.agentPlatform, this.summary, final  List<String> editableFields = const <String>[], this.decision, this.decidedAt, this.expiresAt}): _payload = payload,_editableFields = editableFields,super._();
...
@override final  DecisionType? decision;
