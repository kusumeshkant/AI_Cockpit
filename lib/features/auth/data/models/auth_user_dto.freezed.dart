...
mixin _$AuthUserDto {
 ...
 String get id; String get email; String? get displayName; String? get workspaceId; String get plan;
...
@override
String toString() {
  return 'AuthUserDto(id: $id, email: $email, displayName: $displayName, workspaceId: $workspaceId, plan: $plan)';
}
...
@useResult
$Res call({
 String id, String email, String? displayName, String? workspaceId, String plan
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String? displayName,  String? workspaceId,  String plan)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthUserDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String? displayName,  String? workspaceId,  String plan)  $default,) {final _that = this;
switch (_that) {
case _AuthUserDto():
return $default(_that.id,_that.email,_that.displayName,_that.workspaceId,_that.plan);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String? displayName,  String? workspaceId,  String plan)?  $default,) {final _that = this;
switch (_that) {
case _AuthUserDto() when $default != null:
return $default(_that.id,_that.email,_that.displayName,_that.workspaceId,_that.plan);case _:
  return null;
...
class _AuthUserDto extends AuthUserDto {
  const _AuthUserDto({required this.id, required this.email, this.displayName, this.workspaceId, this.plan = 'solo'}): super._();
